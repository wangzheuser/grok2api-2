window.renderAdminHeader = async function renderAdminHeader() {
  ...
  const HEADER_HTML_CACHE_KEY = `grok2api.admin_header_html.${scriptVersion}.models`;
      ...
      <header class="admin-header">
        <div class="admin-header-inner">
          ...
          <nav class="admin-nav">
            ...
            <a href="/admin/models" class="admin-nav-link" data-nav="/admin/models">模型信息</a>
            <a href="/admin/proxies" class="admin-nav-link" data-nav="/admin/proxies">代理池</a>
